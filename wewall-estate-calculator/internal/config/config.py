...
class Config:
    db_pass: str = os.environ.get('WEWALL_ESTATE_CALCULATOR_POSTGRES_PASSWORD')
    db_user: str = os.environ.get('WEWALL_ESTATE_CALCULATOR_POSTGRES_USER')
    db_name: str = os.environ.get('WEWALL_ESTATE_CALCULATOR_POSTGRES_DB_NAME')
    db_host: str = os.environ.get('WEWALL_ESTATE_CALCULATOR_POSTGRES_CONTAINER_NAME')
    db_port: str = "5432"

    income_tax_share: float = 0.06

    http_port: int = int(os.environ.get('WEWALL_ESTATE_CALCULATOR_PORT'))
    prefix = os.environ.get('WEWALL_ESTATE_CALCULATOR_PREFIX')
    service_name = "wewall-estate-calculator"

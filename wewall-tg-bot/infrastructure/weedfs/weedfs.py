...
class Weed(interface.IStorage):
    def __init__(self, weed_master_host: str, weed_master_port: str):
        self.storage = op.WeedOperation("http://"+weed_master_host+":"+weed_master_port)
    ...
    def upload(self, file: io.BytesIO, name: str):
